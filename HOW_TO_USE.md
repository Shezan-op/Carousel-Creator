...
Go to the **Setup** tab to fine-tune the output:
...
Format your text using app-specific formatting tokens—not standard Markdown—to trigger visual effects:

* `*highlight*`: Triggers a custom "highlight" visual accent (e.g., background blocks in Brutalist, colored text in Minimal).
