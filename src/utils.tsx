 ...
 */
export const renderHighlightedText = (text: string, template: string, accentColor: string) => {
    if (!text) return null;
    ...
    // 3. Parse Italic (_text_) - Using a negative lookahead/behind or strictly matching non-underscores 
    // to avoid colliding with the underline syntax or HTML attributes.
